...
def swipe_by_direction(driver, dir):
    ...
    if dir == 'right':
        ...
        driver.swipe(width * 0.80, height * 0.50, width * 0.20, height * 0.50,
                     1000)
    elif dir == 'up':
        driver.swipe(width * 0.50, height * 0.70, width * 0.50, height * 0.30,
                     1000)
    else:
        driver.swipe(width * 0.50, height * 0.30, width * 0.50, height * 0.70,
                     1000)
...
def is_player_activity(driver):
    player_activity = [
        '.PlayerActivity', 'com.miui.videoplayer.VideoPlayerActivity',
